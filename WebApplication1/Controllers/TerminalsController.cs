...
namespace WebApplication1.Controllers
{
    public class TerminalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Terminal terminal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Terminal terminal)
        {
            if (id != terminal.Id)
            {
                return NotFound();
