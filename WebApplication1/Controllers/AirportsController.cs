...
namespace WebApplication1.Controllers
{
    public class AirportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Code,City,Country")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Code,City,Country")] Airport airport)
        {
            if (id != airport.Id)
            {
                return NotFound();
